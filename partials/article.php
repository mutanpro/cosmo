...
<?php if ($article['id_kategori'] == 1000) : ?>
	<?php
	$detail = $this->db->get_where('agenda', ['id_artikel' => $article['id']])->row_array() ?>
						...
						<div class="info-box bg-green">
							...
							<div class="info-box-content">
								...
								<span class="progress-description">
									<?= tgl_pendek_jam($detail['tgl_agenda']) ?> WIB</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="widget-content">
						<div class="info-box bg-orange">
							...
							<div class="info-box-content">
								<span class="info-box-text">Tempat</span>
					...
					<div class="widget-content">
						<div class="info-box bg-red">
							...
							<div class="info-box-content">
								...
								<span class="progress-description">
									<?= $detail['koordinator_kegiatan'] ?> </span>
							</div>
						</div>
					</div>
				</div>
